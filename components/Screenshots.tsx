...
const shots = [
  ...
  },
  {
    src: '/shots/shop.png',
    title: 'Armory',
    desc: 'Wireframe 3D weapon datalink with typewriter dossier text',
    accent: '#2ea89a',
    span: 'col-span-1',
  },
  {
    ...
    title: 'Player Setup',
    desc: 'Up to 10 tanks, local multiplayer — humans or AI',
    accent: '#5fd6c6',
    span: 'col-span-1',
  },
  {
    ...
    title: 'How To Play',
    desc: 'Keyboard, mouse-drag and full touch control schemes',
    accent: '#c2321f',
    span: 'col-span-1',
  },
];
